ARDUINO_HOME ?=
LIBARDUINO=-larduino-LilyPadUSB
...
CFLAGS               +=-std=c99 -mmcu=atmega32u4 -Os -DF_CPU=8000000L -DBAUD=9600 -I$(ARDUINO_HOME)/hardware/tools/avr/avr/include -I$(ARDUINO_HOME)/hardware/arduino/avr/cores/arduino -I$(ARDUINO_HOME)/hardware/arduino/avr/variants/leonardo -DUSB_VID=0x1B4F -DUSB_PID=0x9208
CXXFLAGS             +=-std=c++14 -mmcu=atmega32u4 -Os -DF_CPU=8000000L -DBAUD=9600 -I$(ARDUINO_HOME)/hardware/tools/avr/avr/include -I$(ARDUINO_HOME)/hardware/arduino/avr/cores/arduino -I$(ARDUINO_HOME)/hardware/arduino/avr/variants/leonardo -DUSB_VID=0x1B4F -DUSB_PID=0x9208

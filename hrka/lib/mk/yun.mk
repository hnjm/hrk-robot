...
CFLAGS               +=-std=c99 -mmcu=atmega32u4 -Os -DF_CPU=16000000L -DBAUD=9600 -I$(ARDUINO_HOME)/hardware/tools/avr/avr/include -I$(ARDUINO_HOME)/hardware/arduino/avr/cores/arduino -I$(ARDUINO_HOME)/hardware/arduino/avr/variants/yun -DUSB_VID=0x2341 -DUSB_PID=0x8041
CXXFLAGS             +=-std=c++14 -mmcu=atmega32u4 -Os -DF_CPU=16000000L -DBAUD=9600 -I$(ARDUINO_HOME)/hardware/tools/avr/avr/include -I$(ARDUINO_HOME)/hardware/arduino/avr/cores/arduino -I$(ARDUINO_HOME)/hardware/arduino/avr/variants/yun -DUSB_VID=0x2341 -DUSB_PID=0x8041
